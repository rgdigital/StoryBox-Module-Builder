StoryBox.Module.ConnectivitySeminar = function(options) {
...
StoryBox.Module.ConnectivitySeminar.prototype.images = {
	'sb-bg' : 'https://res.cloudinary.com/rgdigital/image/upload/v1549365752/StoryBox/modules/connectivity_seminar/im_bg.jpg',
	'sb-title' : 'https://res.cloudinary.com/rgdigital/image/upload/v1549368000/StoryBox/modules/connectivity_seminar/im_title.png',
	'sb-connect_icon' : 'https://res.cloudinary.com/rgdigital/image/upload/v1549365843/StoryBox/modules/connectivity_seminar/im_icon.png',
	'sb-ring sb-ring_01' : 'https://res.cloudinary.com/rgdigital/image/upload/v1549365752/StoryBox/modules/connectivity_seminar/im_ring_01.png',
	'sb-ring sb-ring_02' : 'https://res.cloudinary.com/rgdigital/image/upload/v1549365745/StoryBox/modules/connectivity_seminar/im_ring_02.png',
	'sb-ring sb-ring_03' : 'https://res.cloudinary.com/rgdigital/image/upload/v1549365745/StoryBox/modules/connectivity_seminar/im_ring_03.png',
	'sb-ring sb-ring_04' : 'https://res.cloudinary.com/rgdigital/image/upload/v1549365746/StoryBox/modules/connectivity_seminar/im_ring_04.png',
	'sb-ring sb-ring_05' : 'https://res.cloudinary.com/rgdigital/image/upload/v1549365749/StoryBox/modules/connectivity_seminar/im_ring_05.png',
	'sb-ring sb-ring_06' : 'https://res.cloudinary.com/rgdigital/image/upload/v1549365752/StoryBox/modules/connectivity_seminar/im_ring_06.png'
}

StoryBox.Module.ConnectivitySeminar.prototype.onScroll = function(data) {
	for (var i = 0; i < this.instances.length; i++) {
...
StoryBox.Module.ConnectivitySeminar.prototype.scrollCheck = function(element, data) {
	var self = this;
...
StoryBox.Module.ConnectivitySeminar.prototype.getInstances = function() {
	return document.getElementsByClassName('sb-connectivityseminar');
}

StoryBox.Module.ConnectivitySeminar.prototype.createInstances = function(instance) {
	this.addImages(instance);
	this.default(instance);
}

StoryBox.Module.ConnectivitySeminar.prototype.addImages = function(instance) {
	// var ringID = 1;
...
StoryBox.Module.ConnectivitySeminar.prototype.createImage = function(key, url, className, append) {
...
StoryBox.Module.ConnectivitySeminar.prototype.default = function(instance) {
...
StoryBox.Module.ConnectivitySeminar.prototype.animate = function(instance) {

	var bg = instance.getElementsByClassName('sb-bg');
	var rings = instance.getElementsByClassName('sb-ring');
	// var rings = '.sb-ring_01, .sb-ring_02, .sb-ring_03, .sb-ring_04, .sb-ring_05, .sb-ring_06';
	var title = instance.getElementsByClassName('sb-title');
	var drone = instance.getElementsByClassName('sb-connect_icon');
...
StoryBox.Module.ConnectivitySeminar.prototype.getShiftDistance = function(instance, scrollTop, modifier) {
...
StoryBox.Module.ConnectivitySeminar.prototype.getScrollTop = function(scrollTop, modifier) {
	return Math.abs(0-(scrollTop*modifier));
};

StoryBox.Module.ConnectivitySeminar.prototype.parallax = function(instance, data) {
	...
	if (pos) {
		...
		TweenMax.to(drone, speed, {y:getShift(2.10), ease:Power1.easeOut})
