StoryBox.Module.CapabilitySeminar = function(options) {
...
StoryBox.Module.CapabilitySeminar.prototype.images = {
	'sb-bg' : 'https://res.cloudinary.com/rgdigital/image/upload/v1549369719/StoryBox/modules/capability_seminar/im_bg.jpg',
	'sb-title' : 'https://res.cloudinary.com/rgdigital/image/upload/v1549371382/StoryBox/modules/capability_seminar/im_title.png',
	'sb-connect_icon' : 'https://res.cloudinary.com/rgdigital/image/upload/v1549370050/StoryBox/modules/capability_seminar/im_icon.png',
	'sb-ring sb-ring_01' : 'https://res.cloudinary.com/rgdigital/image/upload/v1549369719/StoryBox/modules/capability_seminar/im_ring_01.png',
	'sb-ring sb-ring_02' : 'https://res.cloudinary.com/rgdigital/image/upload/v1549369718/StoryBox/modules/capability_seminar/im_ring_02.png',
	'sb-ring sb-ring_03' : 'https://res.cloudinary.com/rgdigital/image/upload/v1549369717/StoryBox/modules/capability_seminar/im_ring_03.png',
	'sb-ring sb-ring_04' : 'https://res.cloudinary.com/rgdigital/image/upload/v1549369717/StoryBox/modules/capability_seminar/im_ring_04.png',
	'sb-ring sb-ring_05' : 'https://res.cloudinary.com/rgdigital/image/upload/v1549369717/StoryBox/modules/capability_seminar/im_ring_05.png',
	'sb-ring sb-ring_06' : 'https://res.cloudinary.com/rgdigital/image/upload/v1549369718/StoryBox/modules/capability_seminar/im_ring_06.png'
}

StoryBox.Module.CapabilitySeminar.prototype.onScroll = function(data) {
	for (var i = 0; i < this.instances.length; i++) {
...
StoryBox.Module.CapabilitySeminar.prototype.scrollCheck = function(element, data) {
	var self = this;
...
StoryBox.Module.CapabilitySeminar.prototype.getInstances = function() {
	return document.getElementsByClassName('sb-capabilityseminar');
}

StoryBox.Module.CapabilitySeminar.prototype.createInstances = function(instance) {
	this.addImages(instance);
	this.default(instance);
}

StoryBox.Module.CapabilitySeminar.prototype.addImages = function(instance) {
	// var ringID = 1;
...
StoryBox.Module.CapabilitySeminar.prototype.createImage = function(key, url, className, append) {
...
StoryBox.Module.CapabilitySeminar.prototype.default = function(instance) {
...
StoryBox.Module.CapabilitySeminar.prototype.animate = function(instance) {
...
StoryBox.Module.CapabilitySeminar.prototype.getShiftDistance = function(instance, scrollTop, modifier) {
...
StoryBox.Module.CapabilitySeminar.prototype.getScrollTop = function(scrollTop, modifier) {
	return Math.abs(0-(scrollTop*modifier));
};

StoryBox.Module.CapabilitySeminar.prototype.parallax = function(instance, data) {
