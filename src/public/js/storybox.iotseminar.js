StoryBox.Module.IotSeminar = function(options) {
...
StoryBox.Module.IotSeminar.prototype.images = {
	'sb-bg' : 'https://res.cloudinary.com/rgdigital/image/upload/v1549365709/StoryBox/modules/iot_seminar/im_bg.jpg',
	'sb-title' : 'https://res.cloudinary.com/rgdigital/image/upload/v1549365709/StoryBox/modules/iot_seminar/im_title.png',
	'sb-lock_icon' : 'https://res.cloudinary.com/rgdigital/image/upload/v1549365707/StoryBox/modules/iot_seminar/im_lock.png',
	'sb-ring sb-ring_01' : 'https://res.cloudinary.com/rgdigital/image/upload/v1549365708/StoryBox/modules/iot_seminar/im_ring_01.png',
	'sb-ring sb-ring_02' : 'https://res.cloudinary.com/rgdigital/image/upload/v1549365707/StoryBox/modules/iot_seminar/im_ring_02.png',
	'sb-ring sb-ring_03' : 'https://res.cloudinary.com/rgdigital/image/upload/v1549365708/StoryBox/modules/iot_seminar/im_ring_03.png',
	'sb-ring sb-ring_04' : 'https://res.cloudinary.com/rgdigital/image/upload/v1549365707/StoryBox/modules/iot_seminar/im_ring_04.png',
	'sb-ring sb-ring_05' : 'https://res.cloudinary.com/rgdigital/image/upload/v1549365709/StoryBox/modules/iot_seminar/im_ring_05.png',
	'sb-ring sb-ring_06' : 'https://res.cloudinary.com/rgdigital/image/upload/v1549365708/StoryBox/modules/iot_seminar/im_ring_06.png'
}

StoryBox.Module.IotSeminar.prototype.onScroll = function(data) {
	for (var i = 0; i < this.instances.length; i++) {
...
StoryBox.Module.IotSeminar.prototype.scrollCheck = function(element, data) {
	var self = this;
...
StoryBox.Module.IotSeminar.prototype.getInstances = function() {
	return document.getElementsByClassName('sb-iotseminar');
}

StoryBox.Module.IotSeminar.prototype.createInstances = function(instance) {
	this.addImages(instance);
	this.default(instance);
}

StoryBox.Module.IotSeminar.prototype.addImages = function(instance) {
	// var ringID = 1;
...
StoryBox.Module.IotSeminar.prototype.createImage = function(key, url, className, append) {
...
StoryBox.Module.IotSeminar.prototype.default = function(instance) {
...
StoryBox.Module.IotSeminar.prototype.animate = function(instance) {

	var bg = instance.getElementsByClassName('sb-bg');
	var rings = instance.getElementsByClassName('sb-ring');
	// var rings = '.sb-ring_01, .sb-ring_02, .sb-ring_03, .sb-ring_04, .sb-ring_05, .sb-ring_06';
	var title = instance.getElementsByClassName('sb-title');
	var drone = instance.getElementsByClassName('sb-lock_icon');
...
StoryBox.Module.IotSeminar.prototype.getShiftDistance = function(instance, scrollTop, modifier) {
...
StoryBox.Module.IotSeminar.prototype.getScrollTop = function(scrollTop, modifier) {
	return Math.abs(0-(scrollTop*modifier));
};

StoryBox.Module.IotSeminar.prototype.parallax = function(instance, data) {
