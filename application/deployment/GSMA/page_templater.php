<?php
/*
 * Allows for page templates to be added
 * Author: Harri Bell-Thomas - WPExplorer Author
 * Author URI: https://www.wpexplorer.com/wordpress-page-templates-plugin/
...
class PageTemplater_storybox_template_plugin {
  ...
  private function __construct() {
    ...
    // ADD TEMPLATES HERE!
    $this->templates = array(
      'template_view.php' => 'StoryBox Template Plugin'
    );
